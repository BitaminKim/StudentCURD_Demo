...
public class UpdateStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    DiskFileItemFactory disk = new DiskFileItemFactory(1024*1024*10,new File(tmpPath));
	        ...
	        for (FileItem fileItem : list) {
	        	if (!fileItem.isFormField()) {
	        		...
	        		if ("id".equals(fileItem.getFieldName())) {
	        			user.setId(Integer.valueOf(fileItem.getString("UTF-8")).intValue());
                    }
...
//		user.setId((int)Integer.valueOf(req.getParameter("id")));
